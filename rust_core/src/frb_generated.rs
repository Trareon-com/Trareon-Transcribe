...
fn wire__crate__api__flight_entry_count_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::flight_entry_count())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__flight_read_log_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::flight_read_log())?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__is_model_downloaded_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::is_model_downloaded(
                        api_models_dir,
                        api_model_id,
                    ))?;
                    std::result::Result::Ok(output_ok)
...
fn wire__crate__api__list_available_models_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::list_available_models(api_models_dir))?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
